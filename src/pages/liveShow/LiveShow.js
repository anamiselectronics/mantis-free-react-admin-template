    ...
    <Card sx={{ width: '40%' }}>
      ...
      <CardContent>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <Typography variant="subtitle1">دوربین: {name}</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="subtitle1">دقت: {name}</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="subtitle1">مجوز: {name}</Typography>
          </Grid>
          <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            <Typography variant="subtitle1">رنگ: {name}</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography variant="subtitle1">پلاک: {name}</Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="subtitle1">{additionalInfo1}</Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="subtitle1">{additionalInfo2}</Typography>
          </Grid>
        </Grid>
      </CardContent>
    </Card>
