...
//  const isButtonDisabled = !plateNumbers.some((plateNumber) => plateNumber[0].length === 8);
...
//     const validPlateNumbers = plateNumbers.filter((plateNumber) => plateNumber.length === 8);

//     if (validPlateNumbers.length === 0) {
//       // Optionally provide user feedback if no valid plate numbers are entered
//       return;
//     }

//     const newPlateEntries = validPlateNumbers.map((plateNumberPart, index) => ({
